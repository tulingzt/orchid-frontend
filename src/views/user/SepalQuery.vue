...
<template>
  <div class="sepal-query-container">
    ...
    <DataTable
      :columns="columns"
      :data="sepalStore.items"
      :total="sepalStore.pagination.total"
      :page-size="sepalStore.pagination.limit"
      :loading="sepalStore.loading"
      :showActions=false
    ...
    <!-- 错误提示 -->
    <el-alert
      v-if="sepalStore.error"
      :title="sepalStore.error"
      type="error"
      show-icon
      class="mt-4"
    />
